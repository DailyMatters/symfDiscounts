 ...
 */
final class Version20180915161332 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customer_id_id INTEGER NOT NULL, total DOUBLE PRECISION NOT NULL)');
        ...
        $this->addSql('CREATE TABLE item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id_id INTEGER NOT NULL, order_id VARCHAR(255) NOT NULL, quantity INTEGER NOT NULL, unit_price DOUBLE PRECISION NOT NULL, total DOUBLE PRECISION NOT NULL)');
